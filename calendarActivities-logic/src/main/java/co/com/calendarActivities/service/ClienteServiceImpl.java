...
import co.com.calendarActivities.repository.ClienteRepository;
...
public class ClienteServiceImpl implements ClienteService {
	...
	public void save(Cliente cliente) throws Exception {
		...
		if(entity!=null) {
			throw new Exception("El cliente no se puede crear porque ay existe");
		}
	...
	public void update(Cliente cliente) throws Exception {
		...
		Cliente entity= clienteRepository.findById(cliente.getClieId());
		if(entity==null) {
			throw new Exception("El cliente no se puede modificar porque ay existe");
		}
